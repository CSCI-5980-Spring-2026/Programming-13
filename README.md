# Programming 13: Rigid Body Simulation

In this live programming class, we will implement discrete rigid body simulation using the [Bullet Physics SDK](https://github.com/bulletphysics/bullet3).
...
The cellular noise shader was adapted from [The Book of Shaders](https://thebookofshaders.com/12/).
